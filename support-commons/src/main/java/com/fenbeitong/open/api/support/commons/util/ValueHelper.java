...
public class ValueHelper {
     ...
     */
    public static <T> List<Map<String, String>> tranList2MapList(List<T> list, String[] ignoreProperties) throws IllegalAccessException, IntrospectionException, InvocationTargetException {
     ...
     */
    public static Map<String, String> transBean2Map(Object bean, Map<String, String> map, String[] ignoreProperties) throws IllegalAccessException, IntrospectionException, InvocationTargetException {
     ...
     * @return Map<String, Object>
     */
    public static Map<String, String> transBean2Map(Object bean, Map<String, String> map, String[] ignoreProperties, String dateFormatPattern,
                                                    String keyPrefix, boolean includeNull) throws IntrospectionException, InvocationTargetException, IllegalAccessException {
