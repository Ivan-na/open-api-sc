...
import com.fenbeitong.open.api.service.jwt.support.commons.constants.WebConstants;
  ...
  public static <T> T get(String url, Class<T> returnClassName, Map<String, String> parameters) {
    RestTemplate restTemplate =
        new RestTemplateBuilder()
            ...
            .setConnectTimeout(Duration.ofSeconds(WebConstants.REST_CALL_CONNECT_TIMEOUT_SECONDS))
            .setReadTimeout(Duration.ofSeconds(WebConstants.REST_CALL_READ_TIMEOUT_SECONDS))
            .build();
