...
import com.fenbeitong.open.api.support.web.caller.handler.CustomErrorHandler;
import com.fenbeitong.open.api.support.web.caller.handler.CustomLogHandler;
  ...
  public static <T> T get(String url, Class<T> returnClassName, Map<String, String> parameters) {
    RestTemplate restTemplate =
        new RestTemplateBuilder()
            ...
            .setConnectTimeout(Duration.ofSeconds(WebConstant.REST_CALL_CONNECT_TIMEOUT_SECONDS))
            .setReadTimeout(Duration.ofSeconds(WebConstant.REST_CALL_READ_TIMEOUT_SECONDS))
            .build();
